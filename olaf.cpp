...
HRESULT olaf::init()
{
	...
	KEYANIMANAGER->addArrayFrameAnimation("olafRightFallDownDead", "olaf_Sprite", rightFallDownDead, 3, 5, false,hitDead,this);									//오른쪽 추락사

	int leftFallDownDead[] = { 79,78,77 };
	KEYANIMANAGER->addArrayFrameAnimation("olafLeftFallDownDead", "olaf_Sprite", leftFallDownDead, 3, 5, false, hitDead, this);									//왼쪽   추락사
	...
	KEYANIMANAGER->addArrayFrameAnimation("olafRightHitDead", "olaf_Sprite", rightHitDead, 7, 3, false,hitDead,this);								//오른쪽 맞아 죽음
